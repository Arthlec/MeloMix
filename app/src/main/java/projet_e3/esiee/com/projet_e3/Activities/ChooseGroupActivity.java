    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonInformation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setMessage("Si vous choisissez d'organiser l'évènement, les autres utilisateurs participants se connecteront à votre appareil. Vous serez le propriétaire de l'évènement, en cas de déconnexion l'évènement sera annulé.");
